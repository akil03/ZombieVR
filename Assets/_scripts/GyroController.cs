...
public class GyroController : MonoBehaviour 
{
	...
	public Sprite SwipeTex, GyroTex;
	public Transform gyroIcon;
	...
	{
		gyroIcon.GetComponent<SpriteRenderer>().sprite=SwipeTex;
		AttachGyro();
		Invoke("EnableGyro",1);
	...
	void GyroButton(){
		...
		if (gyroEnabled) {
			gyroEnabled = false;
			gyroIcon.GetComponent<SpriteRenderer>().sprite=GyroTex;
		}
		else{
			gyroEnabled = true;
			gyroIcon.GetComponent<SpriteRenderer>().sprite=SwipeTex;
